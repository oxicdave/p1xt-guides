...
Complete [The Odin Project](https://www.theodinproject.com/). Follow the Ruby on Rails path then, after finishing, go to the JavaScript path and do the NodeJS module. **Do all optional material**
...
| Complete the [Specialization](#specializations) below - note: you may elect to complete another round of a specialization you selected in a prior tier, or branch out and complete a different specialization. |            |              |
